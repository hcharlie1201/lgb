defmodule LgbWeb.Components.SignedInNav do
  ...
  def render(assigns) do
    ...
    <nav
      id={assigns.id}
      class={["sticky z-10 flex w-full flex-row items-start justify-around self-start p-2 backdrop-blur-md md:w-64 md:flex-col md:justify-start md:p-2"]}
    >
      <.live_component
        module={LgbWeb.Components.Geolocation}
        id="user-geolocation-hook"
      ...
      <.link navigate={~p"/profiles/current"} class="loggedinNavLinks">
        ...
        <span class="userNavText">Profile</span>
      </.link>
      <.link navigate={~p"/starred"} class="loggedinNavLinks group">
        ...
        <span class="userNavText">Starred</span>
      </.link>
      <.link class="loggedinNavLinks" navigate={~p"/profiles"}>
        ...
        <span class="userNavText">Search</span>
      </.link>
    ...
    <!-- Notification Badge -->
      ...
      <.link class="loggedinNavLinks" navigate={~p"/chat_rooms"}>
        ...
        <span class="userNavText">Chatroom</span>
      </.link>
      <.link class="loggedinNavLinks" navigate={~p"/shopping/subscriptions"}>
        ...
        <span class="userNavText">Premium</span>
      </.link>
      <.link class="loggedinNavLinks" href={~p"/meetups"}>
        ...
        <span class="userNavText">Events</span>
      </.link>
      <.link class="loggedinNavLinks" href={~p"/account"}>
        ...
        <span class="userNavText">Account</span>
      </.link>
    </nav>
    """
  end
